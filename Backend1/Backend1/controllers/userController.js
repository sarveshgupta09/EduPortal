...
return res.status(200).json({mesaage:"welcome Teacher",role:userData.role,id:userData._id,token ,userData})
    }
...
try {
    ...
    secure:true,
    auth:{
        user:"krishnakumarchaurasia6@gmail.com",
        pass:"krishna2026"
    },
    tls:{
   ...
   trasporter.sendMail({
    from:"krishnakumarchaurasia6@gmail.com",
    to:`${addUser.email}`,
